 ...
 */
final class OrdersSDK implements OrdersSDKInterface, \AmazonPHP\SellingPartner\Api\OrdersV0Api\OrdersSDKInterface
{
     ...
     */
    public function confirmShipment(AccessToken $accessToken, string $region, string $order_id, ConfirmShipmentRequest $payload)
    {
     ...
     */
    public function confirmShipmentRequest(AccessToken $accessToken, string $region, string $order_id, ConfirmShipmentRequest $payload) : RequestInterface
    {
     ...
     * @param null|\App\Classes\SellingPartner\Model\Orders\ItemApprovalType[] $item_approval_types When set, only return orders that contain items which approval type is contained in the specified approval types. (optional)
     * @param null|\App\Classes\SellingPartner\Model\Orders\ItemApprovalStatus[] $item_approval_status When set, only return orders that contain items which approval status is contained in the specified approval status. (optional)
     *
     * @throws ApiException on non-2xx response
     * @throws InvalidArgumentException
     */
